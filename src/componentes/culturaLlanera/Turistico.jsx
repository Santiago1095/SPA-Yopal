      ...
      <div class="row ">
        ...
        <div class="col-6 py-5">
          <p class="card text-bg-light m-4 border border-light text-start fs-6 fst-italic">
            ...
            población podría soñar, es por eso que en Yopal Casanare buscan que
            los paisajes son uno de los principales atractivos que tiene el
            departamento, por lo que sumado a los aspectos naturales que ofrece
            este territorio y hermosos atardeceres consoliden al municipio como
            un lugar al que las personas en el país aspiren a conocer.{" "}
          </p>
          <ul>
            <ul class="card text-bg-light m-3 border border-light text-start fs-6 fst-italic">
