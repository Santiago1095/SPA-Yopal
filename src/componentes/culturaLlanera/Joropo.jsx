      ...
      <div class="row ">
        ...
        <div class="col-6 py-5">
          <p class="card text-bg-light m-4 border border-light text-start fs-6 fst-italic">
            El joropo es un género musical y danza tradicional de Venezuela y
            Colombia. Su diversidad se manifiesta en distintas tipologías
            subregionales. Entre ellas cabe mencionar el joropo oriental, el
            joropo central, el joropo andino y el golpe larense en Venezuela;
            además del joropo llanero y los cantos de trabajo de los llanos en
            Venezuela y Colombia, En 2017, la Unesco incluyó los cantos de arreo
            y ordeño, en la Lista Representativa de Patrimonio Cultural
