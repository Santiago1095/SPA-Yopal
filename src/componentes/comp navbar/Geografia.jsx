    ...
    <div class="container text-center py-2 border border-dark p-4 mb-4 border-opacity-25 ">
      <div class="row">
        ...
        <div class="rounded-start-5 col-6 py-5 bg-primary-subtle">
          <p class="card text-bg-light m-4 border  text-start fs-5 fst-italic bg-primary-subtle">
            Yopal es la ciudad capital del departamento colombiano de Casanare,
            ubicada cerca del río Cravo Sur, en el piedemonte de la cordillera
            Oriental. Por su topografía el municipio presenta tres pisos
            térmicos, cuyas áreas son: Cálido 1906 km², Medio 106 km² y Frío 25
            km²
          </p>
