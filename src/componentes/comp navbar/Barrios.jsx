    ...
    <div class="container text-center py-2 border border-dark p-4 mb-4 border-opacity-25 " >
      ...
      <div class="row">
        ...
        <div class="rounded-start-5 col-6 py-2 bg-primary-subtle">
          ...
          <p class="card text-bg-light m-4 border  text-start fs-6 fst-italic bg-primary-subtle">La Cabecera municipal de Yopal se encuentra dividida en siete comunas, las cuales comprenden 124 barrios:
          <br />  <br />
            <ul>
