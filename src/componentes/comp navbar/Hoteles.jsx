    ...
    <div class="container text-center py-2 border border-dark p-4 mb-4 border-opacity-25 " >
      ...
      <div class="row">
        ...
        <div class="rounded-start-5 col-6 py-2 bg-primary-subtle">
          ...
          <p class="card text-bg-light m-4 border  text-start fs-6 fst-italic bg-primary-subtle">Yopal cuenta con una gran cantidad de hoteles, la mayoría de ellos creados en la década de los 90 con el fin de servir a la creciente industria petrolera. Sin embargo, en los últimos años se ha dado un interés por parte de grandes cadenas hoteleras nacionales e internacionales que buscan establecerse en la ciudad:
            <br />     <br />
