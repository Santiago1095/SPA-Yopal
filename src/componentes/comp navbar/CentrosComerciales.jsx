  ...
  return (
    ...
    <div class="container text-center py-2 border border-dark p-4 mb-4 border-opacity-25 " >
      ...
      <div class="row">
        ...
        <h5 class="text-center py-2 fs-1 fst-italic text-dark">Centros Comerciales</h5>

        <div class="rounded-start-5 col-6 py-2 bg-primary-subtle">

          <p class="card text-bg-light m-4 border  text-start fs-6 fst-italic bg-primary-subtle">Yopal cuenta con varios centros comerciales, algunos de ellos de gran formato:
            <br />
            <ul>
