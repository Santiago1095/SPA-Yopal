      ...
      <div class="row ">
        ...
        <div class="col-6 py-5">
          <p class="card text-bg-light m-4 border border-light text-start fs-6 fst-italic">
            Yopal deriva su nombre de un árbol maderable, típico de la región,
            cuyo nombre es "yopo". De hecho, en el sitio donde se ubica
            actualmente la ciudad de Yopal existía un bosque de estos árboles o
            un yopal (bosque de yopos). El nombre "Yopo" es proveniente de la
            lengua indígena, los Salivas, y significa corazón
          </p>
